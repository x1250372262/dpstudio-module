package com.dpstudio.module.doc.format;

import com.dpstudio.module.doc.bean.*;
...
public class MarkdownFormat implements Format {
    ...
    private static final VelocityTemplater VELOCITY_TEMPLATER = new VelocityTemplater("com/dpstudio/module/doc/format/markdown.vm");

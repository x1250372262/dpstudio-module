package com.dpstudio.module.doc.web;
...
import com.dpstudio.module.doc.format.Format;
import com.dpstudio.module.doc.format.HtmlForamt;
import com.dpstudio.module.doc.format.MarkdownFormat;
...
public class ApiController {
    ...
    public IView index() throws Exception {
        ...
        return HtmlView.bind(WebMVC.get(), "/dpstudio/doc/index.html");
    }
    ...
    public IView create() throws Exception {
        apiResult = DOC.getDoc();
        return View.redirectView("/dpstudio/doc/index.html");
    }

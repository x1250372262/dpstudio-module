...
import com.dpstudio.module.wxminiprogram.impl.DefaultWxMiniProgramConfig;
import com.dpstudio.module.wxminiprogram.utils.PKCS7Encoder;
...
public final class WxMiniProgram implements IModule, IWxMiniProgram {
    ...
    public void initialize(IApplication owner) throws Exception {
        if (!initialized) {
            //
            YMP.showVersion("Initializing dpstudio-module-wxminiprogram-${version}", new Version(2, 0, 0, WxMiniProgram.class, Version.VersionType.Alpha));
            //
            this.owner = owner;
            if (config == null) {

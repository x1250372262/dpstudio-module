...
import com.mx.module.doc.converter.TagConverterRegister;
import com.mx.module.doc.impl.ApiHelper;
import com.mx.module.doc.impl.DefaultDocConfig;
...
public final class Doc implements IModule, IDoc {
    ...
    public void initialize(IApplication owner) throws Exception {
        if (!initialized) {
            //
            YMP.showVersion("Initializing mx-dev-doc-doc-${version}", new Version(1, 0, 0, Doc.class, Version.VersionType.Alpha));
            //
            this.owner = owner;
            if (config == null) {

...
import com.mx.module.doc.format.Format;
import com.mx.module.doc.format.HtmlForamt;
import com.mx.module.doc.format.MarkdownFormat;
...
public class ApiController {
    ...
    public IView index() throws Exception {
        ...
        return HtmlView.bind(WebMVC.get(), "/mx/doc/index.html");
    }
    ...
    public IView create() throws Exception {
        apiResult = DOC.getDoc();
        return View.redirectView("/mx/doc/index.html");
    }
    ...
    public IView rebuild() {
        return View.redirectView("/mx/wd/create");
    }

...
public final class DefaultSecurityConfig implements ISecurityConfig {
    ...
    private DefaultSecurityConfig(Class<?> mainClass, IModuleConfigurer moduleConfigurer) {
        ...
        secret = configReader.getString(SECRET, confAnn != null ? confAnn.secret() : "mxJwt");
        headerName = configReader.getString(HEADER_NAME, confAnn != null ? confAnn.headerName() : "mxJwt");
        paramName = configReader.getString(PARAM_NAME, confAnn != null ? confAnn.paramName() : "mxJwt");
        headerClientName = configReader.getString(HEADER_CLIENT_NAME, confAnn != null ? confAnn.paramName() : "mxJwtClientName");

...
/**
 * SecuritySetting generated By EntityMojo on 2021/03/15 10:00:12
 *
...
public class SecuritySetting extends BaseEntity<SecuritySetting, String> {
    ...
    @Property(name = FIELDS.CLIENT_NAME, length = 100)
    @Comment("")
    ...
    public SecuritySetting(String id, String clientName, Integer loginLogStatus, Integer loginErrorCount, Integer loginErrorTime, Integer loginErrorStatus, Integer loginNotIpStatus, Integer loginNotIpNotice, Long lastModifyTime, String lastModifyUser) {
        this.id = id;
    ...
    public SecuritySetting(IDatabase dbOwner, String id, String clientName, Integer loginLogStatus, Integer loginErrorCount, Integer loginErrorTime, Integer loginErrorStatus, Integer loginNotIpStatus, Integer loginNotIpNotice, Long lastModifyTime, String lastModifyUser) {
        super(dbOwner);
        this.id = id;
        this.clientName = clientName;
        this.loginLogStatus = loginLogStatus;
    ...
    public static FieldConditionBuilder conditionBuilder(SecuritySetting entity) {
        return conditionBuilder(entity, null);
    }

    public static FieldConditionBuilder conditionBuilder(SecuritySetting entity, String prefix) {
    ...
    public static class FieldConditionBuilder extends AbstractFieldConditionBuilder {
        ...
        public FieldCondition loginLogStatus() {
            return createFieldCondition(FIELDS.LOGIN_LOG_STATUS);
        }
        ...
        public FieldCondition loginErrorTime() {
            return createFieldCondition(FIELDS.LOGIN_ERROR_TIME);
        }

        public FieldCondition loginErrorStatus() {
            return createFieldCondition(FIELDS.LOGIN_ERROR_STATUS);
        }

        public FieldCondition loginNotIpStatus() {
            return createFieldCondition(FIELDS.LOGIN_NOT_IP_STATUS);
        }

        public FieldCondition loginNotIpNotice() {
            return createFieldCondition(FIELDS.LOGIN_NOT_IP_NOTICE);
        }

...
/**
 * SecurityAdmin generated By EntityMojo on 2021/03/15 10:00:12
 *
...
public class SecurityAdmin extends BaseEntity<SecurityAdmin, String> {
    ...
    public SecurityAdmin(IDatabase dbOwner) {
        super(dbOwner);
    }

    public SecurityAdmin(String id, String clientName, String userName, String password, String createUser, Long createTime, Long lastModifyTime, String lastModifyUser, String salt, Integer deleteStatus, Integer disableStatus, Integer founder) {
        this.id = id;
        ...
        public SecurityAdmin(IDatabase dbOwner, String id, String clientName, String userName, String password, String createUser, Long createTime, Long lastModifyTime, String lastModifyUser, String salt, Integer deleteStatus, Integer disableStatus, Integer founder) {
            super(dbOwner);
            this.id = id;
            this.clientName = clientName;
            this.userName = userName;
    ...
    public SecurityAdmin(IDatabase dbOwner, String id, String clientName, String userName, String realName, String photoUri, String password, String mobile, Integer gender, String createUser, Long createTime, Long lastModifyTime, String lastModifyUser, String createIpAddr, String salt, Integer deleteStatus, Integer disableStatus, Integer founder, Integer loginErrorCount, Integer loginLockStatus, Long loginLockStartTime, Long loginLockEndTime, String sessionToken) {
        super(dbOwner);
        this.id = id;
        this.clientName = clientName;
        this.userName = userName;
    ...
    public static class Builder {
        ...
        private final SecurityAdmin targetEntity;

        public Builder() {
            targetEntity = new SecurityAdmin();
        }

        public Builder(IDatabase dbOwner) {
            targetEntity = new SecurityAdmin(dbOwner);
        }

        public Builder(SecurityAdmin targetEntity) {
        ...
        public String createIpAddr() {
            return targetEntity.getCreateIpAddr();
        }

        public Builder createIpAddr(String createIpAddr) {
            targetEntity.setCreateIpAddr(createIpAddr);
            return this;
        }
        ...
        public Integer deleteStatus() {
            return targetEntity.getDeleteStatus();
        }

        public Builder deleteStatus(Integer deleteStatus) {
            targetEntity.setDeleteStatus(deleteStatus);
            return this;
        }
        ...
        public String sessionToken() {
            return targetEntity.getSessionToken();
        }
    ...
    public interface FIELDS {
        ...
        String CREATE_IP_ADDR = "create_ip_addr";
        String SALT = "salt";
    ...
    public static FieldConditionBuilder conditionBuilder(SecurityAdmin entity) {
        return conditionBuilder(entity, null);
    }

    public static FieldConditionBuilder conditionBuilder(SecurityAdmin entity, String prefix) {
    ...
    public static class FieldConditionBuilder extends AbstractFieldConditionBuilder {
        ...
        public FieldCondition createIpAddr() {
            return createFieldCondition(FIELDS.CREATE_IP_ADDR);
        }
        ...
        public FieldCondition deleteStatus() {
            return createFieldCondition(FIELDS.DELETE_STATUS);
        }
        ...
        public FieldCondition sessionToken() {
            return createFieldCondition(FIELDS.SESSION_TOKEN);
        }
    }
}

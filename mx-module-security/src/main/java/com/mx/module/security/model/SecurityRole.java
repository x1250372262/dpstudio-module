...
/**
 * SecurityRole generated By EntityMojo on 2021/03/15 10:00:12
 *
...
public class SecurityRole extends BaseEntity<SecurityRole, String> {
    ...
    public SecurityRole(String id, String clientName, String name, String createUser, Long createTime, String lastModifyUser, Long lastModifyTime) {
        this.id = id;
        ...
        public SecurityRole(IDatabase dbOwner, String id, String clientName, String name, String createUser, Long createTime, String lastModifyUser, Long lastModifyTime) {
            super(dbOwner);
            this.id = id;
            this.clientName = clientName;
            this.name = name;
    ...
    public SecurityRole(String id, String clientName, String name, String remark, String createUser, Long createTime, String lastModifyUser, Long lastModifyTime) {
        this.id = id;
        this.clientName = clientName;
        this.name = name;
        this.remark = remark;
    ...
    public SecurityRole(IDatabase dbOwner, String id, String clientName, String name, String remark, String createUser, Long createTime, String lastModifyUser, Long lastModifyTime) {
        super(dbOwner);
        this.id = id;
        this.clientName = clientName;
        this.name = name;

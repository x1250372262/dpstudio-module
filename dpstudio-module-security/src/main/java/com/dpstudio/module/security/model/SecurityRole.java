...
/**
 * SecurityRole generated By EntityMojo on 2020/11/09 10:09:05
 *
...
public class SecurityRole extends BaseEntity<SecurityRole, String> {
    ...
    public SecurityRole(String id, String name, String createUser, Long createTime, String lastModifyUser, Long lastModifyTime) {
        ...
        public SecurityRole(IDatabase dbOwner, String id, String name, String createUser, Long createTime, String lastModifyUser, Long lastModifyTime) {
            super(dbOwner);
            this.id = id;
            this.name = name;
            this.createUser = createUser;
    ...
    public SecurityRole(IDatabase dbOwner, String id, String name, String remark, String createUser, Long createTime, String lastModifyUser, Long lastModifyTime) {
        super(dbOwner);
        this.id = id;
        this.name = name;
        this.remark = remark;

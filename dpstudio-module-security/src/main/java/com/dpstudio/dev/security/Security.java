...
import com.dpstudio.dev.security.utils.UnpackUtils;
            ...
            categoryMap.forEach((k, v) -> {
                ...
                propertyMap.forEach((k1, v1) -> {
                    MenuBean menuBean = MenuBean.builder()
                            .id(com.dpstudio.dev.security.utils.Objects.get(v1.getAttribute("id"), ""))
                            .name(StringUtils.defaultIfBlank(v1.getName(), ""))
                            .value(StringUtils.defaultIfBlank(v1.getContent(), ""))
                            .icon(com.dpstudio.dev.security.utils.Objects.get(v1.getAttribute("icon"), ""))
                            .url(com.dpstudio.dev.security.utils.Objects.get(v1.getAttribute("url"), ""))
                            .pid(com.dpstudio.dev.security.utils.Objects.get(v1.getAttribute("pid"), ""))
                            .permissions(com.dpstudio.dev.security.utils.Objects.get(v1.getAttribute("permissions"), ""))

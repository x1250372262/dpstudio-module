...
<ymp:ui src="admin/base/base">
    <ymp:property name="title">登录日志</ymp:property>
                                        ...
                                        <div class="section_flex">
                                            ...
                                            <div class="select_flex">
                                                ...
                                                <input class="js-datetimepicker times" autocomplete="off"
                                                       data-date-format="yyyy-mm-dd hh:ii" type="text" id="start_time"
                                                       name="startTime" placeholder="从">
                                                <span class="input-group-addon" style="text-align: center;width: 50px;"><i
                                                        class="mdi mdi-chevron-right"></i></span>
                                                <input class="js-datetimepicker times" autocomplete="off"
                                                       data-date-format="yyyy-mm-dd hh:ii" type="text" id="end_time"
                                                       name="endTime" placeholder="至">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="tableAjaxId" class="table table-bordered"
                                           listurl="/dpstudio/security/admin/log/list?admin_id=${param.id}">
                                    </table>
                                </div>
                            </div>
                        </div>
